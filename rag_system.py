...
class RAGSystem:
    ...
    def retrieve_relevant_products(self, query: str, preferences: Dict[str, Any], top_k: int = 10) -> List[Dict[str, Any]]:
        logger.info(f"Retrieving products for query: '{query}' with preferences: {preferences}")
